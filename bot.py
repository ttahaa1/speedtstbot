...
def forward_message(update, context):
    ...
    forwarded_user_id = update.message.forward_from.id if update.message.forward_from else None
    if forwarded_user_id and user_id != forwarded_user_id:
        ...
        context.bot.send_message(chat_id=forwarded_user_id, text=reply_text)
    else:
